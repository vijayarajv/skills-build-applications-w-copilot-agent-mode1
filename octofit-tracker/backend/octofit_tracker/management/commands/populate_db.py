...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            team1.members = [{"username": user.username, "email": user.email} for user in [users[0], users[1]]]
            team2.members = [{"username": user.username, "email": user.email} for user in [users[2], users[3], users[4]]]
            team1.save()
            team2.save()
